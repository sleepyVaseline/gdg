export const siteConfig = {
  ...
  funFacts: [
    { label: "Currently listening to", value: "Prateek Kuhad — cold/mess" },
    { label: "Currently reading", value: "The God of Small Things — Arundhati Roy" },
    { label: "Favourite spot in the city", value: "Evening walks around Cubbon Park" },
  ],
  social: {
